    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(NoteKeeperActivity.this, MainActivity.class));
            }
        });
...
//                Intent intent = new Intent(NoteKeeperActivity.this, MainActivity.class);
...
//        });
        ...
        recycleNotes.setLayoutManager(notesLayoutManager);

        List<NoteInfo> notes = DataManager.getInstance().getNotes();
        mNoteRecyclerAdapter = new NoteRecyclerAdapter(this, notes);
        recycleNotes.setAdapter(mNoteRecyclerAdapter);
    }
